...
namespace Fungus
{
    ...
    {
        [Tooltip("Root object containing the stage positions.")]
        [SerializeField] protected RectTransform portraitRoot;
        ...
        /// </summary>
        public virtual RectTransform PortraitRoot { get { return portraitRoot; } }
