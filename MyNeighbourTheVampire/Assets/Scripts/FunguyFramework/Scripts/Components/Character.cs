...
namespace Fungus
{
    ...
    public class Character : MonoBehaviour, ILocalizable
    {
        ...
        [SerializeField] protected List<PortraitData> portraits;

        [Tooltip("Direction that portrait sprites face.")]
        [SerializeField] protected FacingDirection portraitsFace;

		[Tooltip("The prefab to spawn as the graphic of the character")]
		[SerializeField] protected PortraitGraphic graphicPrefab;
        ...
        /// </summary>
        public virtual List<PortraitData> Portraits { get { return portraits; } }
        ...
        public virtual Sprite ProfileSprite { get { return profileSprite; } }
		...
		/// <summary>
		/// The prefab to spawn as the graphic of the character
		/// </summary>
		public virtual PortraitGraphic GraphicPrefab { get { return graphicPrefab; } }

		/// <summary>
		/// Image to use for the background when this character is speaking
		/// </summary>
		public virtual Sprite BackgroundImage { get { return backgroundImage; } }
        ...
        /// </summary>
        public virtual PortraitData GetPortrait(string portraitString)
        {
